...
public class CreateCourseAndStudentsDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Student tempStudent1=new Student("jitendra","sai","abc@gmail.com");
			Student tempStudent2=new Student("jit","sai","drt@gmail.com");
			Student tempStudent3=new Student("balu","subh","vbb@gmail.com");
